...
for _, v in ipairs({"crow","bou","kick","hh","bou","clap","usb","op1"}) do stop(v) end
...
play("crow",shufexpand("ab4 ab5 bb3",16),1)

stop("usb")
play("usb",shufexpand("ab1 ab1 ab1 eb2 eb2 . . . "),1)
play("usb",shufexpand("b2 e1 b2 ."),2)
play("usb",shufexpand("gb1 gb3 db"),3)
play("usb",shufexpand("eb1 eb2 bb3 eb1 . "),4)
