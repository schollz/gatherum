...
e.d_amp(0.0)
play("drone",sound("db6","e.d_midi(<m>)"),1)
...
ta:rm("kick")
play("kick",er(4),1)
play("kick",add(er(2),rot(er(1),3)),2)
...
ta:rm("drone")
e.d_amp(0.6)
play("drone",sound("d5","e.d_midi(<m>)"),1)
play("drone",sound("f#5","e.d_midi(<m>)"),2)
play("drone",sound("f#5 g","e.d_midi(<m>)"),3)
play("drone",sound("b4","e.d_midi(<m>)"),4)
